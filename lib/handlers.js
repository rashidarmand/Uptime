...
handlers._users.get = (data, callback)=>{
  ...
  if(phone) {
    ...
    // Verify that given token from headers is valid for the phone number
  ...
  if(id) {
    ...
    _data.read('checks', id, (err, checkData)=>{
      if(!err && checkData){
        ...
        // Verify that given token from headers is valid and belongs to the user who created the check
